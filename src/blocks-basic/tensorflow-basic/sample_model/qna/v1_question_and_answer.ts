...
import {BertTokenizer, CLS_INDEX, loadTokenizer, SEP_INDEX, type Token} from './v1_bert_tokenizer';
...
export class QuestionAndAnswerImpl implements QuestionAndAnswer {
  ...
  async load() {
    ...
    window.bert_model = this.model;
    const surface = tfvis.visor().surface({ name: 'Model Summary', tab: 'Model Inspection' });
